...
// Lazy load GoogleIcon to reduce initial bundle
const GoogleIcon = dynamic(() => Promise.resolve(({ className }: { className?: string }) => (
    ...
    <div className="w-full max-w-sm">
      <div className="card p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-xl text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <GoogleIcon className="w-5 h-5" />
          {googleLoading ? t("auth.sending") : t("auth.signInWithGoogle")}
        </button>
